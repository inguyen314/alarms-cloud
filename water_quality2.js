                                ...
                                return timeSeries.map((series, index) => {
                                    ...
                                    return fetch(apiUrl, {
                                        ...
                                        .then(data => {
                                            ...
                                            // Push the fetched data to locData['temp-water-api-data']
                                            locData['temp-water-api-data'].push(data);

                                            // Instead of a single array, create a new key in locData for the tsid
                                            const lastValue = getLastNonNullValue(data);
                                            if (!locData['temp-water-last-value']) {
                                                locData['temp-water-last-value'] = {}; // Initialize the object if it doesn't exist
                                            }

                                            // Push the last value to a new array for the specific tsid
                                            locData['temp-water-last-value'][tsid] = lastValue;
